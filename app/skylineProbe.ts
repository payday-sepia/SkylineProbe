...
export default function SkylineProbe() {
  ...
  async function runProbe() {
    setStatus("Probing Base network…");
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 900, margin: "52px auto", fontFamily: "system-ui" }}>
        <h1>SkylineProbe — Built for Base</h1>
